---
description: In this example we will show how to forecast data with multiple seasonalities
  using an MSTL.
...
For this task, StatsForecast’s MSTL is 68% more accurate and 600% faster
than [Prophet](https://facebook.github.io/prophet/) and
...
series](./Getting_Started_complete.ipynb).
...
should take around 10 seconds. The second time -once Numba compiled your
settings- it should take less than 5s.
...
![](MultipleSeasonalities_files/figure-markdown_strict/cell-11-output-1.png)
